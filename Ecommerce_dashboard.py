...
# Poore data (df_clean) par train hoga, filter se independent
# taaki prediction hamesha stable rahe
# ---------------------------------------------------------
@st.cache_resource
...
# ---------------------------------------------------------
# Sidebar: Spend Prediction Tool (user apna detail fill karega)
# ---------------------------------------------------------
st.sidebar.markdown("---")
st.sidebar.header("🔮 Predict Customer Spend")
st.sidebar.caption("Apni details bharo, model predict karega total spend.")
